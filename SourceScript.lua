	...
	LoadButton.MouseButton1Down:Connect(function()
		if LoadFocus == false then
			...
			repeat wait()
				...
				TitleLoad.Text = "Get Patch Salad X  Script Version : 3.0.0"
				wait(0.35)
				TweenService:Create(
					TitleLoad,
					TweenInfo.new(.5, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut),
				...
				TitleLoad.Text = "Welcome to Salad X Script | Premium Edition"
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Salad X Hub Premium Scripts/Blox Fruits/") then
			makefolder("Salad X Premium Scripts/Blox Fruits/")
		end
...
-- local CreditL = Page_Credits.Label({Title = "Made By Salad X Team"})
